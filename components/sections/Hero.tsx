          ...
          <div className="md:col-span-3 space-y-8">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-2xl">
                Software engineering student specializing in full-stack web development 
                and AI-powered solutions. I build scalable applications with modern 
            ...
            <div className="space-y-6">
              <div className="flex flex-wrap gap-3">
                ...
                <a
                  href="#contact"
                  className="px-8 py-3 border border-gray-300 text-gray-700 rounded-lg hover:border-blue-500 hover:text-blue-600 transition-colors font-medium"
                >
                  Contact Me
                </a>
              </div>
              ...
              <div className="text-sm text-gray-500">
                Currently studying Software Engineering • Open to internships & collaborations
              </div>
            </div>
          </div>
